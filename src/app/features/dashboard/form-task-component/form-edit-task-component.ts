...
export class FormEditTaskComponent {
    ...
    titleControl = new FormControl<string>('w', [Validators.required, Validators.minLength(3), Validators.maxLength(255)]);
    descriptionControl = new FormControl<string>('w', [Validators.required, Validators.minLength(3), Validators.maxLength(255)]);
    tagControl = new FormControl<string>('w', [Validators.required, Validators.minLength(1), Validators.maxLength(25)]);
    ...
    onSubmit() {
        if (this.form.valid) {
            this.taskUpdated.emit(this.form.getRawValue());
        }
    }
}
